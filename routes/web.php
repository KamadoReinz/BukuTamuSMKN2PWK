...
Route::get('admin/tambah', [AdminTamuController::class, 'formTambah'])->name('admin-form-tambah');
Route::post('admin/simpan-data', [AdminTamuController::class, 'simpanData'])->name('admin-simpan-data');
Route::get('admin/edit/{id}', [AdminTamuController::class, 'formEdit'])->name('admin-form-edit');
